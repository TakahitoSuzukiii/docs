...
- [useful coding style guides](https://github.com/NARKOZ/guides#guides "useful coding style guides")

# リアーキテクチャ

- [リファクタリング、リアーキテクティング、ビック・リライトの選択〜技術的負債とダンスを(4)](https://twop.agile.esm.co.jp/rafactoring-rearchitecting-bigrewrite-18549cd60004 "リファクタリング、リアーキテクティング、ビック・リライトの選択〜技術的負債とダンスを(4)")
